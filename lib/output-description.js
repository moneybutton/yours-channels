...
class OutputDescription extends Struct {
  constructor (intermediateDestId, finalDestId, kind, htlcSecret, revocationSecret, amount) {
    super()
    this.fromObject({intermediateDestId, finalDestId, kind, htlcSecret, revocationSecret, amount})
  }
  ...
  toPublic () {
    ...
    outputDescription.kind = this.outputDescription
