...
class Agent extends Struct {
  ...
  setCommitmentTxo (obj) {
    ...
    this.other.rhtlcRedeemScript = obj.rhtlcRedeemScript
    this.other.htlcRedeemScript = obj.rhtlcRedeemScript
  }
   ...
   */
  asyncSetOtherCommitmentTx (txb, htlcRedeemScript, rhtlcRedeemScript) {
    return asink(function *() {
      ...
      this.htlcRedeemScript = htlcRedeemScript
      this.rhtlcRedeemScript = rhtlcRedeemScript
  ...
  asyncSend (amount, amountToOther, revocationSecret, txb) {
    return asink(function *() {
      this.other.revocationSecrets.push(revocationSecret)
      this.setCommitmentTxo(yield CnlTxBuilder.asyncBuildCommitmentTxo(amount, amountToOther, this.spending, this.funding, this.multisig, this.other, this.htlcSecret, this.funder))
      ...
      if (!this.sender) {
        ...
        yield this.remoteAgent.asyncSendTxb(this.commitmentTxb, this.other.htlcRedeemScript, this.other.rhtlcRedeemScript)
      }
    }, this)
  }

  asyncSendTxb (txb, htlcRedeemScript, rhtlcRedeemScript) {
    return asink(function *() {
      // check the other parties commitment transaction
      yield this.asyncSetOtherCommitmentTx(txb, htlcRedeemScript, rhtlcRedeemScript)
