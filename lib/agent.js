...
class Agent extends Struct {
   ...
   */
  storeOtherFundingTxHash (amount, fundingTxhashbuf, fundingTxout) {
   ...
   */
  storeOtherRevocationSecret (revocationSecret) {
    if (!this.other) {
  ...
  storeOtherRevocationSecretSolution (secret) {
    return asink(function *() {
  ...
  asyncBuildFundingTx (amount, inputTxHashbuf, inputTxoutnum, inputTxout, pubKey) {
    return asink(function *() {
      if (!this.initialized) {
   ...
   */
  asyncBuildCommitmentTxb (amount, amountToOther) {
    return asink(function *() {
      if (!this.initialized) {
   ...
   */
  asyncBuildSpendingTx (commitmentTx) {
    return asink(function *() {
   ...
   * This is branch 1.1.2 in the picture
   */
  asyncBuildOtherSpendingTx (commitmentTx) {
    return asink(function *() {
   ...
   * This is branch 1.1.2 in the picture
   */
  asyncBuildHtlcEnforcementTx (commitmentTx) {
    return asink(function *() {
   ...
   */
  asyncBuildOtherHtlcEnforcementTx (commitmentTx) {
    return asink(function *() {
   ...
   * This is branch 1.1.2 in the picture
   */
  asyncSpendRevokedCommitmentTx (commitmentTx) {
    return asink(function *() {
      let revocationSecrets = this.other.revocationSecrets
   ...
   */
  buildNonStandardTx (commitmentTx, scriptSig, sigPos, txoutnum) {
    return asink(function *() {
 ...
 */
/*
Agent.amountSpentToAddress (tx, address) {
  let amount = Bn(0)
