 ...
 */
Agent.prototype.asyncBuildParitalPaymentTx = function (amountToOther, script, nlocktime) {
  return asink(function *() {
    if (!this.initialized) {
      throw new Error('Agent must me initialized before partial funding transaction can be made')
    }
...
Agent.prototype.asyncSendPayment = function (amount, script) {
  return asink(function *() {
    if (!this.funded) {
...
Agent.addressScript = function (address) {
  return address.toScript()
}

Agent.htlcScript = function (pubkey) {
