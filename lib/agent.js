...
class Agent extends Struct {
   ...
   */
  asyncSetCommitmentTxo (commitmentTxo) {
    return asink(function *() {
  ...
  checkRevocationSecret (secret) {
    return asink(function *() {
      ...
      let storedRevocationSecret = this.other.commitmentTxos[this.other.commitmentTxos.length - 1].revocationSecret
      ...
      this.other.commitmentTxos[this.other.commitmentTxos.length - 1].revocationSecret = secret
    }, this)
  }
  ...
  asyncSendTxb (commitmentTxo) {
    return asink(function *() {
      ...
      yield this.asyncSetCommitmentTxo(commitmentTxo)
      ...
      if (!this.sender) {
        ...
        if (this.commitmentTxos.length > 2) {
  ...
  asyncSendRevocationSecret (revocationSecret) {
    return asink(function *() {
      if (!this.checkRevocationSecret(revocationSecret)) {
  ...
  toJson () {
    ...
    json.nextRevocationSecret = this.nextRevocationSecret
    let commitmentTxos = []
    ...
    if (typeof this.fundingTxo !== 'undefined') {
  ...
  fromJson (json) {
    ...
    if (typeof json.fundingTxo !== 'undefined') {
