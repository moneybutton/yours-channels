...
Agent.prototype.asyncBuildCommitmentTxb = function (amount, amountToOther) {
  return asink(function *() {
    console.log(this.name, 'is building a commitment transaction');
...
Agent.prototype.asyncAcceptCommitmentTx = function (txb) {
  return asink(function *() {
    console.log(this.name, 'is signing and storing a commitment transaction');
...
Agent.prototype.asyncBuildSpendingTxb = function (commitmentTx) {
  return asink(function *() {
    // console.log(this.name, 'spending');
...
console.log('pubkey used in input script', this.spending.keyPair.pubKey.toString('hex'));
    ...
    scriptSig.setChunkBuffer(1, sig.toTxFormat())
    txb.tx.txIns[0].script = scriptSig

    console.log();
    console.log('input script: ', txb.tx.txIns[0].script.toString());
    console.log('output script: ', commitmentTx.txOuts[0].script.toString());
    console.log();
