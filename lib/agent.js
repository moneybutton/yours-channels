...
Agent.prototype.asyncSend = function (amount, amountToOther, revocationSecret) {
  return asink(function *() {
    this.other.revocationSecret = revocationSecret
    ...
    if (!this.sender) {
      yield this.remoteAgent.asyncSend(amount, amountToOther, this.revocationSecret.hidden())
    } else {
