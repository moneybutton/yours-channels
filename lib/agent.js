...
class Agent extends Struct {
  ...
  asyncSendOutputList (outputList, changeOutput) {
    return asink(function *() {
      ...
      commitmentTxo.outputList = this.completeOutputList(outputList)
      commitmentTxo.changeOutput = this.completeChangeOutput(changeOutput)
  ...
  completeOutputList (outputList) {
    // TODO
    return outputList
  }

  completeChangeOutput (changeOutput) {
    // TODO
    return changeOutput
  }
