...
Agent.prototype.asyncAcceptCommitmentTx = function (txb) {
  return asink(function *() {
    // console.log(this.name, 'accepting');
    this.commitmentTxb = yield txb.asyncSign(0, this.multisig.keypair, this.fundingTxout)
    let txVerifier = Txverifier(this.commitmentTxb.tx, this.commitmentTxb.utxoutmap)
...
Agent.prototype.asyncBuildSpendingTxb = function (commitmentTx) {
  return asink(function *() {
    ...
    // console.log(commitmentTx.txouts[0].script.toString());
