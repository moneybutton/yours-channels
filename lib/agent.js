 ...
 */
Agent.prototype.asyncBuildCommitmentTx = function (amount, script, amountToOther, scriptToOther) {
  return asink(function *() {
    if (!this.initialized) {
...
Agent.prototype.asyncBuildHtlcTx = function (amount, amountToOther) {
  return asink(function *() {
    let script = this.htlcScript('this is a secret')
    let scriptToOther = this.rhtlcScript('this is also a secret')
    let txb = yield this.asyncBuildCommitmentTx(amount, script, amountToOther, scriptToOther)
    return txb
  }, this)
}
...
/*
 * this constructs a HTLC to agent
 */
...
/*
 * this constructs a revocable HTLC to otherAgent
 */
