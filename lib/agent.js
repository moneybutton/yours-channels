...
Agent.prototype.asyncBuildCommitmentTxb = function (amount, amountToOther) {
  return asink(function *() {
    ...
    let htlcScript = Scripts.htlc(this)
    let rhtlcScript = Scripts.rhtlc(this)
...
Agent.prototype.asyncBuildSpendingTxb = function (commitmentTx) {
  return asink(function *() {
    let txb = yield this.buildNonStandardTx(commitmentTx, Scripts.spendFromRhtlc(this), 1, this.rhtlcOutNum)
    return txb
  }, this)
}
 ...
 * This is branch 1.1.2 in the picture
 */
Agent.prototype.asyncBuildOtherSpendingTxb = function (commitmentTx) {
  return asink(function *() {
    let txb = yield this.buildNonStandardTx(commitmentTx, Scripts.spendFromHtlc(this), 1, this.htlcOutNum)
    return txb
  }, this)
}
 ...
 * This is branch 1.1.2 in the picture
 */
Agent.prototype.asyncBuildHtlcEnforcementTxb = function (commitmentTx) {
  return asink(function *() {
 ...
 */
Agent.prototype.asyncBuildOtherHtlcEnforcementTxb = function (commitmentTx) {
  return asink(function *() {
...
console.log('output script:', commitmentTx.txOuts[txoutnum].script.toString());
*/
    return txb
  }, this)
}
