...
Agent.prototype.asyncBuildHtlcEnforcementTxb = function (commitmentTx) {
  return asink(function *() {
    let txb = yield this.buildNonStandardTx(commitmentTx, Scripts.enforceFromHtlc())
    return txb
  }, this)
}
...
Agent.prototype.asyncBuildOtherHtlcEnforcementTxb = function (commitmentTx) {
  return asink(function *() {
    let txb = yield this.buildNonStandardTx(commitmentTx, Scripts.enforceFromRhtlc())
    return txb
  }, this)
}
 ...
 */
Agent.prototype.buildNonStandardTx = function (commitmentTx, scriptSig) {
  return asink(function *() {
