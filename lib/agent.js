...
class Agent extends Struct {
  ...
  asyncInitialize (sourcePrivKey, multisigPrivKey, spendingPrivKey) {
    return asink(function *() {
      if (!sourcePrivKey || !multisigPrivKey || !spendingPrivKey || sourcePrivKey.constructor.name !== 'PrivKey' || multisigPrivKey.constructor.name !== 'PrivKey' || spendingPrivKey.constructor.name !== 'PrivKey') {
