...
Sender.prototype.asyncCreateAndSignRefundTx = function (changeaddr, txhashbuf, txoutnum, txout) {
  return this.asyncCreateAndSignPaymentTx(0, changeaddr, txhashbuf, txoutnum, txout)
}
 ...
 */
Sender.prototype.asyncCreateAndSignPaymentTx = function (amountToSend, changeaddr, txhashbuf, txoutnum, txout) {
  return asink(function *() {
    if (!this.msScript) {
