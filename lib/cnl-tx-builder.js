  ...
  static asyncBuildRefundTxb () {
    return asink(function *() {
      return yield CnlTxBuilder
        .asyncBuildCommitmentTxo(Bn(0), this.funding.amount, this.spending, this.funding, this.multisig, this.other, this.htlcSecret, this.funder)
    }, this)
  }
*/
  /*
  ...
  static asyncBuildSpendingTx (commitmentTx, redeemScript, spending, htlcSecret, rhtlcOutNum) {
    return asink(function *() {
      return yield CnlTxBuilder
        .buildTxSpendingFromHtlc(spending, commitmentTx, Scripts.spendFromRhtlc(htlcSecret), redeemScript, 1, rhtlcOutNum)
    }, this)
  }
  ...
  static asyncBuildOtherSpendingTx (commitmentTx, redeemScript, spending, htlcSecret, htlcOutNum) {
    return asink(function *() {
      return yield CnlTxBuilder
        .buildTxSpendingFromHtlc(spending, commitmentTx, Scripts.spendFromHtlc(htlcSecret), redeemScript, 1, htlcOutNum)
    }, this)
  }
  ...
  static asyncBuildHtlcEnforcementTx (commitmentTx, redeemScript, spending, htlcOutNum) {
    return asink(function *() {
      return yield CnlTxBuilder.buildTxSpendingFromHtlc(spending, commitmentTx, Scripts.enforceFromHtlc(), redeemScript, 0, htlcOutNum)
    }, this)
  }
   ...
   */
  static buildTxSpendingFromHtlc (spending, commitmentTx, partialScriptSig, redeemScript, sigPos, txoutnum) {
    return asink(function *() {
