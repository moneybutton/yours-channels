...
class CnlTxBuilder extends Struct {
   ...
   */
  static asyncBuildCommitmentTxo (amount, amountToOther, spending, funding, multisig, otherAgent, htlcSecret, funder) {
    return asink(function *() {
      ...
      if (funder) {
        txb.outputToScript(amountToOther, rhtlcRedeemScript)
        txb.setChangeScript(htlcRedeemScript)
        htlcOutNum = 1
        rhtlcOutNum = 0
      } else {
        txb.outputToScript(amount, htlcRedeemScript)
        txb.setChangeScript(rhtlcRedeemScript)
        htlcOutNum = 0
        rhtlcOutNum = 1
      }
      txb.build()
  ...
  // TODO finish p2sh stuff

  static asyncBuildRefundTxb () {
    return asink(function *() {
      return yield CnlTxBuilder
        .asyncBuildCommitmentTxo(Bn(0), this.amountFunded, this.spending, this.funding, this.multisig, this.other, this.htlcSecret, this.funder)
    }, this)
  }
   ...
   */
  static asyncBuildSpendingTx (commitmentTx, spending, htlcSecret, rhtlcOutNum, htlcRedeemScript) {
    return asink(function *() {
      return yield CnlTxBuilder
        .buildTxSpendingFromHtlc(spending, commitmentTx, Scripts.spendFromRhtlc(htlcSecret), 1, rhtlcOutNum, htlcRedeemScript)
    }, this)
  }
  ...
  static asyncBuildOtherSpendingTx (commitmentTx, spending, htlcSecret, htlcOutNum) {
    return asink(function *() {
      return yield CnlTxBuilder
        .buildTxSpendingFromHtlc(spending, commitmentTx, Scripts.spendFromHtlc(htlcSecret), 1, htlcOutNum)
    }, this)
  }
  ...
  static asyncBuildHtlcEnforcementTx (commitmentTx, spending, htlcOutNum) {
    return asink(function *() {
      return yield CnlTxBuilder.buildTxSpendingFromHtlc(spending, commitmentTx, Scripts.enforceFromHtlc(), 0, htlcOutNum)
    }, this)
  }
  ...
  static asyncBuildOtherHtlcEnforcementTx (commitmentTx, spending, rhtlcOutNum) {
    return asink(function *() {
      return yield CnlTxBuilder
        .buildTxSpendingFromHtlc(spending, commitmentTx, Scripts.enforceFromRhtlc(), 0, rhtlcOutNum)
    }, this)
  }
  ...
  static asyncSpendRevokedCommitmentTx (commitmentTx, otherAgent, spending, revocationSecret, rhtlcOutNum) {
    return asink(function *() {
      ...
      return yield CnlTxBuilder
        .buildTxSpendingFromHtlc(spending, commitmentTx, Scripts.revokeRhtlc(revocationSecret), 1, rhtlcOutNum)
    }, this)
  }
   ...
   */
  static buildTxSpendingFromHtlc (spending, commitmentTx, scriptSig, sigPos, txoutnum, redeemScript) {
    return asink(function *() {
      ...
      // scriptSig = Scripts.toP2shInput(scriptSig, redeemScript)
