  ...
  */
  asyncBuild (destination, commitmentTxObj) {
    return asink(function * () {
      ...
      let commitmentTx = commitmentTxo.txb.tx
      let partialScriptSig = this.spendFromRhtlc(commitmentTxo.htlcSecret)
      let redeemScript = commitmentTxo.rhtlcRedeemScript
      let sigPos = 1
      let txoutnum = 0
