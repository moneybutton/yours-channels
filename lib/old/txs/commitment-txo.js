...
class CommitmentTxo extends Struct {
   ...
   */
  asyncCheck (newCommitmentTxo, fundingTxo, multisig) {
    return asink(function *() {
      ...
      // console.log('comparing new:', newCommitmentTxo.htlcSecret.hash.toString('hex'), 'this:', this.htlcSecret.hash.toString('hex'));
